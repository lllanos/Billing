...
<div class="row">
                ...
                <div class="titulo-header__input titulo-header__input__front">
                    ...
                    <div class="titulo__input titulo__input_fecha_fecha">
                        <select class="form-control chosen_title" name="select_anio" id="select_anio">
                            ...
                            <option value="{{ $keyAnio }}" @if($keyAnio==$selected) selected @endif data-route="{{route('publicaciones.getHtmlTablafuentesIndices', ['de' => $valueAnio['de'], 'a' => $valueAnio['a'], 'moneda_id' => ':moneda_id'])}}" data-excelroute="{{ route('publicaciones.export.exportarFuentes', ['de' => $valueAnio['de'], 'a' => $valueAnio['a'], 'moneda_id' => ':moneda_id'])}}">
                                {{ $valueAnio['show'] }}
                            </option>
                            @endforeach
                        </select>
                    ...
                    <div class="">
                        <div class="dropdown dd-on-table" data-toggle="tooltip" data-placement="left" title="">
                            ...
                            <ul class="dropdown-menu pull-right multi-level" role="menu" aria-labelledby="dropdownMenu">
                                <li>
                                    <a href="{{ route('publicaciones.reportes') }}">{{trans('publicaciones.ver_valores')}}</a>
                                </li>
    ...
    <div class="input-group rounded col-xs-12 col-sm-12 col-md-12 mb-_5" role="group" aria-label="...">
        <div class="col-xs-12 col-sm-offset-6 col-sm-6 col-md-offset-6 col-md-6 contenedor_input_dos_btns mb-_5">
            <form class="form_excel" method="POST" data-action="{{ route('publicaciones.export.exportarFuentes', ['de' => $anios[$selected]['de'], 'a' => $anios[$selected]['a']]) }}" id="form_excel">
                {{ csrf_field() }}
