<div class="panel-body panel_con_tablas_y_sub_tablas p-0 contenedor_all_tablas">
	<div class="panel-group acordion colapsable_cero" id="ID_CAMBIAMEEEEEE" role="tablist" aria-multiselectable="true">
        <div class="panel panel-default">
          	<div class="panel-heading panel_heading_collapse p-0 primer_collapse_color" role="tab" id="headingOne_sub_sub_cat">
	            <h4 class="panel-title titulo_collapse m-0 panel_title_btn">
					<a
						...
						data-parent="#ID_CAMBIAMEEEEEE"
						href="#ID_CAMBIAMEEEEEE_PARA_PANELLL" aria-expanded="false"
						aria-controls="ID_CAMBIAMEEEEEE_PARA_PANELLL"
					>
						<div class="d-flex container_datos_drop">
					  		<span class="container_icon_angle d-flex">
							    <i class="fa fa-angle-up"></i> 
						    	{{trans('analisis_precios.materiales_comerciales')}}
						  	</span>
						</div>            
					</a>
						...
						<ul class="dropdown-menu pull-right">
							<li>
                                <a class="modal-historial" href="javascript:void(0)" data-url="">
                              		<i class="fa fa-plus"></i></i> {{trans('analisis_precios.agregar_material_comercial')}}
                                </a>
							</li>
						</ul>
					</div>
            ...
            {{-- Collapse --}}
				<div id="ID_CAMBIAMEEEEEE_PARA_PANELLL" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne_sub_sub_cat">
