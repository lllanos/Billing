<div class="panel-body panel_con_tablas_y_sub_tablas p-0 contenedor_all_tablas">
	{{-- foreach --}}
		<div class="panel-group acordion colapsable_cero" id="ID_CAMBIAR______" role="tablist" aria-multiselectable="true">
			<div class="panel panel-default">
					...
					<div class="panel-heading p-0 panel_heading_collapse primer_collapse_color" role="tab">
						<h4 class="panel-title titulo_collapse m-0 d-flex">
							<a 
								...
								data-parent="#ID_CAMBIAR______" href="#ID_CAMBIAR______PARA_PANEL" 
								aria-expanded="false" aria-controls="ID_CAMBIAR______PARA_PANEL"
							>
				...
				{{-- Fin Dropdown 0 --}}
		        {{-- 1r panel --}}
	          		<div id="ID_CAMBIAR______PARA_PANEL" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
	            		<div class="panel-body panel_sub_tablas pl-1 pt-1 pr-1 pb-0">
	            			{{-- foreach --}}
								<div class="panel-group colapsable_uno" id="ID_CAMBIAR______2" role="tablist" aria-multiselectable="true">
									<div class="panel panel-default">
					                    {{-- Dropdown 1 --}}
				                      		<div class="panel-heading  p-0 panel_heading_collapse segundo_collapse_color" role="tab">
					                        	<h4 class="panel-title titulo_collapse m-0 panel_title_btn">
					                          		<a 
							                            ...
							                            data-parent="#ID_CAMBIAR______2"
							                            href="#ID_CAMBIAR______PARA_PANEL2" aria-expanded="false"
							                            aria-controls="ID_CAMBIAR______PARA_PANEL2"
						                          	>
					                    ...
					                    {{-- Fin Dropdown 1 --}}
										{{-- 3r panel --}}															        
								          	<div id="ID_CAMBIAR______PARA_PANEL2" class="panel-collapse collapse" role="tabpanel">
