...
<div class="modal-header">
  ...
  <h4 class="modal-title">
    {!!trans('redeterminaciones.acciones.' . $instancia)!!}
  </h4>
</div>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="alert alert-info" role="alert">
            <span class="alert-link">{{trans('redeterminaciones.titulo_pasos')}}</span>
            <ul class="modal_lista">
              @foreach(trans('redeterminaciones.pasos.' . $instancia) as $key => $value)
  ...
  $('#poliza').selectize({
      ...
      render: {
          ...
          option_create: (data, escape) => {
             return '<div class="create">' +"{{ trans('redeterminaciones.nueva_poliza') }}" + ': <strong>' + escape(data.input) + '</strong></div>';
           }
      },
