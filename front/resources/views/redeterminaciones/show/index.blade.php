  ...
  <div class="row">
      ...
      <div class="page-header page_header_detalle">
        <h3 class="page_header__titulo">
          ...
          <div class="buttons-on-title">
            @include('redeterminaciones.show.acciones')
          </div>
        </h3>
      </div>
    </div>
    ...
    <div class="col-md-12 estados_contratos">
      <span id="estado_contrato_refresh">
        @include('redeterminaciones.show.estado_contrato')
      </span>
      <span>
        @if($redeterminacion->a_termino)
          <i class="fa fa-check-circle text-success"></i> {{trans('index.solicitud_termino')}}: {{ trans('index.si')}}
        @else
          <i class="fa fa-times-circle text-danger"></i> {{trans('index.solicitud_termino')}}: {{ trans('index.no')}}
        @endif
      </span>
    </div>

    <div class="col-md-8">
      @include('redeterminaciones.show.detalle')
    </div>

    <div class="col-md-4">
      @include('redeterminaciones.show.historial')
    </div>
  </div>
</div>
@endsection
