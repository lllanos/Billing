          ...
          <ul class="dropdown-menu pull-right">
            ...
            @if(!$contrato->isAdendaAmpliacion)
              @permissions(('anticipos-create'))
                <li class="btn_add_anticipo" data-toggle="modal" data-target="#anticipoAddModal"><a> @trans('index.agregar')  @trans('forms.anticipo')</a></li>
              @endpermission
            @endif

            @if($contrato->has_requiere_garantia)
              @permissions(('garantias-manage'))
                <li class="btn_add_garantia" data-toggle="modal" data-target="#garantiaAddModal"><a> @trans('index.validar')  @trans('contratos.garantia')</a></li>
              @endpermission
            @endif
