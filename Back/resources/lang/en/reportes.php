...
return [
	...
	'notas' => [
		...
		'ReporteFinanciero'				=> [
			...
			1	=> 'Ejecutado*: Certificados del mes',
			2	=> 'Vigente*: Importe a la última redeterminacion (aunque no se encuentre aprobada)',
			3	=> 'Saldo a Ejecutar*: Importe  a la última redeterminacion calculada (aunque no se encuentre aprobada)',
			4	=> 'A Ejecutar*: Importe en base a la última redeterminacion calculada con el porcentaje a ejecutar según plan de trabajo +- Desvíos proporcionales',
			5	=> '* La planificación se toma en base al último plan aprobado',
		],
