...
return [
  ...
  'mensajes' => [
    'success' => [
      ...
      'a_firmar' => 'Análisis de Precios listo para firmar',
      'firma' => 'Análisis de Precios firmado con éxito',
    ],
    ...
    'confirmar' => [
      ...
      'a_firmar' => '¿Está seguro que desea firmar el Análisis de Precios de :nombre_completo?',
      'firma' => '¿Está seguro que desea firmar el Análisis de Precios de :nombre_completo?',
    ],
  ],

  'estados' => [
    'nombre' => [
      'sin' => 'Sin análisis de precios', 'borrador' => 'Análisis de precios en borrador',
      ...
      'a_firmar' => 'Análisis de precios pendiente de firmas',
      'firma' => 'Análisis de precios pendiente de una firma',
    ],
