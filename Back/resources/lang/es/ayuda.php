...
return [
	...
	'contratos' => [
		...
		'subtitulo_firmar_contrato' => 'Firmar Contrato',
		'titulo_firmar_Contrato' => 'Con la opción de <strong>Firmar Contrato</strong>, vas a poder certificar que revisaste los datos del contrato y que se puede continuar con la carga del contrato.',
		...
		Completando el dato de Item podrás personalizar tu código de item en función de lo que te hayan enviado en la contratación.<br>
		Podrás realizar copias de los items entre monedas mediante la función de duplicar. Podrás duplicar un item o duplicar todo el itemizado.  Las cantidades y precios se copiaran a las otras monedas en 0 y en caso de anexar nuevos ítems a una moneda se podrá volver a realizar la copia agregando solamente esos ítems en la nueva moneda. <br>
		...
		'items_Completo' => [
			...
			2 => '<strong>Firmar </strong>: Sólo si el tipo de contrato necesita revisiones.',
		],
		...
		'plan_Completo' => [
			...
			6 => '<strong>Firmar</strong>: Sólo si el contrato necesita una instancia de certificación.',
		...
		'lista_certificados' => [
				...
				2 => '<strong>Firmar</strong>: Sólo si el contrato necesita una instancia de certificación.',
			],
	...
	'indices' => [
		...
		'listado_publicaciones' => [
			...
			'descripcion' => 'En esta pantalla podrás visualizar el listado de todas la Publicaciones, con la moneda y las fechas en las que fueron realizadas. Gestionar las nuevas publicaciones y editar los Borradores de las Publicaciones.<br>También podrás:',
			'lista' => [
		...
		'tabla_i_valores' => [
			...
			'lista' => [
				...
				2 => 'Seleccionar la moneda y ver los índices de cada una de las monedas',
				3 => 'Ver los índices no publicados referenciados con color (gris oscuro).',
				4 => 'Exportar o descargar la <strong>Valores</strong> a un archivo Excel.',
				5 => 'Acceder a la <strong>Fuentes</strong> mediante el botón de acceso directo ubicado en la parte superior de la página. ',
			],
		],
		'tabla_i_fuentes' => [
			'titulo' => 'Fuentes',
			...
			'lista' => [
				...
				2 => 'Seleccionar la moneda y ver los índices de cada una de las monedas',
				3 => 'Ver los índices no publicados referenciados con color (gris oscuro).',
				4 => 'Exportar o descargar la <strong> Fuentes</strong> a un archivo Excel.',
				5 => 'Acceder a la <strong>Valores</strong> mediante el botón de acceso directo ubicado en la parte superior de la página.',
			]
		]
	],
	// FIN 'indices'
