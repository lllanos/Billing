                    ...
                    <td class="actions-col noFilter">
                        <div class="dropdown dd-on-table" data-toggle="tooltip" data-placement="left" title="@trans('index.opciones')">
                          ...
                          <ul class="dropdown-menu pull-right">
                            ...
                            @permissions(('analisis_precios-delete'))
                              <li>
                                <a class="eliminar btn-confirmable-prevalidado"
                                data-prevalidacion="{{ route('analisis_item_componente.preDelete', ['id' => $valueComponente->id]) }}"
                                data-body="{{trans('index.confirmar_eliminar.componente', ['nombre' => $valueComponente->nombre])}}"
                                data-action="{{ route('analisis_item_componente.delete', ['id' => $valueComponente->id]) }}"
