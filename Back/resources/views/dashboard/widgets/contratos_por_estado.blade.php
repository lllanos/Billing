<div class="chart-container" id="contratos_por_estado"></div>

<script>
  $(document).ready(function() {

    Highcharts.chart('contratos_por_estado', {
      chart: {
      ...
      credits: {
        ...
        exporting: {
            filename: "{{trans('widgets.contratos_por_estado.nombre')}}_{{date('j_m_Y')}}"
        }
    });
  });
