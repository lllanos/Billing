                                      ...
                                      @if($valueSalto->solicitud != null)
                                        ...
                                        @else
                                          <div class="contenedor_badges_estado_contrato">
                                            ...
                                            <span class="ml-_5">
                                              @if($valueSalto->solicitud != null)
                                                @if($valueSalto->solicitud->a_termino)
                                                  <i class="fa fa fa-check-circle text-success" data-toggle="tooltip" data-placement="top"
                                                  title="@trans('sol_redeterminaciones.a_termino')"></i>
                                                @elseif(!$valueSalto->solicitud->a_termino)
                                                  @if(!$valueSalto->solicitud->tiene_certificado_anterior && $valueSalto->solicitud->getInstancia('CalculoPreciosRedeterminados')->monto_vigente != null)
                                                    <i class="fa fa fa-times-circle text-danger" data-toggle="tooltip" data-placement="top"
                                                    title="@trans('sol_redeterminaciones.falta_certificado_anterior', ['mes' => $valueSalto->solicitud->fecha_certificado_anterior])"></i>
                                                  @else
                                                    <i class="fa fa fa-times-circle text-danger" data-toggle="tooltip" data-placement="top"
                                                    title="@trans('sol_redeterminaciones.no_a_termino')"></i>
                                                  @endif
                                                @endif
                                              @endif
                                            </span>
                                    ...
                                    <div class="dropdown dd-on-table" data-toggle="tooltip" data-placement="left" title="{{ trans('index.acciones')}}">
                                      ...
                                      <ul class="dropdown-menu pull-right">
                                        @if(!$valueSalto->empalme)
                                          ...
                                          @endpermission
                                          @if($valueSalto->solicitud != null)
                                            @permissions(('redeterminaciones-en_proceso-view', 'redeterminaciones-finalizadas-view'))
                                            ...
                                            @endpermission
                                            @if($valueSalto->cuadro_comparativo != null && $valueSalto->solicitud->monto_vigente != null)
                                              @permissions(('redeterminaciones-en_proceso-view', 'redeterminaciones-finalizadas-view'))
