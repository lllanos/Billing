...
@else
  ...
  <a class="btn_ac ordion datos_as_table collapse_arrow dato-importe-porcentaje" role="button" data-toggle="collapse" data-parent="#accordion_sub_a_pre_{{$item->id}}" href="#collapse_sub_a_pre_{{$item->id}}" aria-expanded="true" aria-controls="collapse_sub_a_pre_{{$item->id}}">
    <div class="">
