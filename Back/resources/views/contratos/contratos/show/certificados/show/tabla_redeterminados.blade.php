@foreach ($certificados as $keyFila => $valueFila)
    <div id="collapseOne_certificados" class="panel-collapse collapse in" role="tabpanel"
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="panel-group colapsable_top mt-1" id="accordion_redet_{{$keyFila}}" role="tablist"
                     aria-multiselectable="true">
                    <div class="panel panel-default">
                        <div class="panel-body pt-0 pb-0">
                            <div class="panel-body panel_con_tablas_y_sub_tablas contenedor_all_tablas pt-1 pl-0 pr-0">

                                <div class="panel-heading panel_heading_padre p-0 panel_heading_collapse" role="tab"
                                     id="heading_redet_{{$keyFila}}">
                                    <h4 class="panel-title titulo_collapse panel_heading_0 m-0 panel_title_btn">
                                        <a class="btn_acordion datos_as_table collapse_arrow" role="button"
                                           data-toggle="collapse" data-parent="#accordion_redet_{{$keyFila}}"
                                           href="#collapse_redet_{{$keyFila}}" aria-expanded="false"
                                           aria-controls="collapse_redet_{{$keyFila}}">
                                            ...
                                            <div class="fecha_obra_ultima_redeterminacion_collapse pull-right">
                                                ...
                                                @foreach ($valueFila['ajustes']['data'] as $keyData => $valueData)
                                                    <span class="badge badge-referencias"
                                                          style="background-color:var(--dark-gray-color);margin-top:-6px;">
                                                       {{$valueData}}
                                                    </span>
                                                @endforeach
                                            </div>
                                ...
                                <div id="collapse_redet_{{$keyFila}}" class="panel-collapse collapse" role="tabpanel"
                                     aria-labelledby="heading_sub_redet_{{$keyFila}}">
                                    <div class="row">
                                                    ...
                                                    <div class="zui-scroller zui-no-data">
                                                        ...
                                                        <table class="table table-striped table-hover table-bordered zui-table">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <th class="text-center actions-col">
                                                            ...
                                                            @foreach($valueFila['certificados'] as $certificado)
                                                                <tr id="certificado_{{$certificado->id}}">
                                                                    ...
                                                                    <td class="actions-col noFilter">
                                                                        <div class="dropdown dd-on-table"
                                                                            ...
                                                                            <ul class="dropdown-menu pull-right">
                                                                                ...
                                                                                <li>
                                                                                    <a href="{{route('redeterminaciones.certificado.ver', ['id' => $certificado->id]) }}">
