        ...
        <div class="panel-heading p-0 panel_heading_collapse" role="tab" id="headingOne-certificados">
            <h4 class="panel-title titulo_collapse m-0 panel_title_btn">
                <a class="btn_acordion dos_datos collapse_arrow @if(!isset($fromAjax)) visualizacion @endif"
                   role="button" data-toggle="collapse" data-parent="#accordion-certificados"
                   href="#collapseOne_certificados" aria-expanded="true" aria-controls="collapseOne_certificados"
                   @if(!isset($fromAjax)) data-seccion="certificados" data-version="{{$opciones['version']}}" @endif>
                    <div class="container_icon_angle"><i class="fa fa-angle-down"></i> @trans('forms.certificados')
                    </div>
                </a>
            </h4>
        </div>

        <div id="collapseOne_certificados" class="panel-collapse collapse in" role="tabpanel"
             aria-labelledby="headingOne-certificados">
            @if(isset($fromAjax))
                @if($contrato->has_certificados && !$contrato->falta_completar_empalme)
                    <div class="row">
                        <div class="col-md-12">
                            <!--is basico-->
                            @php ($sufijo = 'basico')
                            <div class="panel-group colapsable_top mt-1" id="accordion{{$sufijo}}" role="tablist"
                                 aria-multiselectable="true">
                                <div class="panel panel-default">
                                    <div class="panel-body pt-0 pb-0">
                                        <div
                                            class="panel-body panel_con_tablas_y_sub_tablas contenedor_all_tablas pt-1 pl-0 pr-0">
                                            <div class="panel-heading panel_heading_padre p-0 panel_heading_collapse"
                                                 role="tab" id="heading{{$sufijo}}">
                                                <h4 class="panel-title titulo_collapse m-0 panel_title_btn">
                                                    <a class="btn_acordion datos_as_table collapse_arrow" role="button"
                                                       data-toggle="collapse" data-parent="#accordion{{$sufijo}}"
                                                       href="#collpapse{{$sufijo}}" aria-expanded="true"
                                                       aria-controls="collpapse{{$sufijo}}">
                                            ...
                                            <div id="collpapse{{$sufijo}}" class="panel-collapse collapse in"
                                                 role="tabpanel" aria-labelledby="headingOne_sub{{$sufijo}}">
                                                <div class="row">
            ...
            @if(count($contrato->certificados_redeterminados) && !$contrato->falta_completar_empalme)
                <div id="collapseOne_certificados" class="panel-collapse collapse in" role="tabpanel"
                     aria-labelledby="headingOne-certificados">
                    @if(isset($fromAjax))
                        <div class="row">
                                    ...
                                    <div class="panel panel-default">
                                        <div class="panel-body pt-0 pb-0">
                                            <div
                                                class="panel-body panel_con_tablas_y_sub_tablas contenedor_all_tablas pt-1 pl-0 pr-0">
                                                <div
                                                    class="panel-heading panel_heading_padre p-0 panel_heading_collapse"
                                                    role="tab" id="heading{{$sufijo}}">
                                                    <h4 class="panel-title titulo_collapse m-0 panel_title_btn">
                                                        <a class="btn_acordion datos_as_table collapse_arrow"
                                                           role="button" data-toggle="collapse"
                                                           data-parent="#accordion{{$sufijo}}"
                                                           href="#collpapse{{$sufijo}}" aria-expanded="true"
                                                           aria-controls="collpapse{{$sufijo}}">
                                                            <div class="container_icon_angle">
