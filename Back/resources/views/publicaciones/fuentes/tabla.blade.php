...
<div class="">
  <div class="panel-body panel_con_tablas_y_sub_tablas p-0 contenedor_all_tablas">
    ...
    <!--Collapse-->
      <div class="panel-group colapsable_top" id="accordion_{{$contador_categoria}}" role="tablist" aria-multiable="true">
            ...
            <div class="panel-body panel_sub_tablas pl-1 pt-1 pr-1 pb-0">
              @foreach($categoria as $keySubcategoria => $subcategoria)
                @if($keySubcategoria != 'N/A')
                  <!--Sub Collpase-->
                    <div class="panel-group colapsable_sub" id="accordion_sub_{{$contador_sub_categoria}}" role="tablist" aria-multiable="true">
                      <div class="panel panel-default">
