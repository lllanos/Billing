            ...
            <label class="fixMargin4">
              <div class="checkbox noMarginChk">
                <div class="btn-group chk-group-btn" data-toggle="buttons">
                  <label class="btn btn-primary btn-sm @if($solicitud->certificados_aprobados) active @endif">
                    <input autocomplete="off" class="triggerClickChk" type="checkbox" name="certificados_aprobados" id="certificados_aprobados" @if($solicitud->certificados_aprobados) checked @endif>
                    <span class="glyphicon glyphicon-ok"></span>
                  </label>
                  @trans('sol_redeterminaciones.aprobar_certificados')
                </div>
              </div>
            </label>
          </div>
