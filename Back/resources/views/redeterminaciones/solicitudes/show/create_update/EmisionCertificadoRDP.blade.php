            ...
            <label class="fixMargin4">
              <div class="checkbox noMarginChk">
                <div class="btn-group chk-group-btn" data-toggle="buttons">
                  <label class="btn btn-primary btn-sm @if($solicitud->certificados_emitidos) active @endif">
                    <input autocomplete="off" class="triggerClickChk" type="checkbox" name="certificados_emitidos" id="certificados_emitidos" @if($solicitud->certificados_emitidos) checked @endif>
                    <span class="glyphicon glyphicon-ok"></span>
                  </label>
                  @trans('sol_redeterminaciones.emitir_certificados')
                </div>
              </div>
            </label>
          </div>
