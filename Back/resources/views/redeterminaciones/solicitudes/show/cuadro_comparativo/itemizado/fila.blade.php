...
@else
  ...
  <a class="btn_acordion datos_as_table collapse_arrow with-border dato-codigo" @if(!$is_hoja)role="button" data-toggle="collapse" data-parent="#accordion_sub_a_pre_{{$item->id}}" href="#collapse_sub_cuad_{{$item->id}}" aria-expanded="true" aria-controls="collapse_sub_cuad_{{$item->id}}" @endif>
  ...
  <a class="btn_acordion datos_as_table collapse_arrow with-border dato-codigo" @if(!$is_hoja)role="button" data-toggle="collapse" data-parent="#accordion_sub_a_pre_{{$item->id}}" href="#collapse_sub_cuad_{{$item->id}}" aria-expanded="true" aria-controls="collapse_sub_cuad_{{$item->id}}" @endif>
      <div class="container_icon_angle">
          {{ $item->item ? $item->item : $item->codigo }}
      </div>
  </a>
  ...
  <a class="btn_acordion datos_as_table collapse_arrow dato-descripcion width_cantidad with-border text-right" @if(!$is_hoja) role="button" data-toggle="collapse" data-parent="#accordion_sub_a_pre_{{$item->id}}" href="#collapse_sub_cuad_{{$item->id}}" aria-expanded="true" aria-controls="collapse_sub_cuad_{{$item->id}}" @endif>
    <div class="">
      @if($is_hoja) @toDosDec($item->cantidad) @endif
   </div>
  </a>

  <a class="btn_acordion datos_as_table collapse_arrow dato-importe" @if(!$is_hoja) role="button" data-toggle="collapse" data-parent="#accordion_sub_a_pre_{{$item->id}}" href="#collapse_sub_cuad_{{$item->id}}" aria-expanded="true" aria-controls="collapse_sub_cuad_{{$item->id}}" @endif>
    <div class="pull-right">
