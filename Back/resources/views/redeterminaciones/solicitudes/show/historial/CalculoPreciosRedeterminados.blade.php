...
@elseif(!$valueInstancia->solicitud->a_termino && !$valueInstancia->solicitud->tiene_certificado_anterior)
  <div class="contenido_proceso_hist_redeterminaciones">
    <span class="contenido_proc_item error-redeterminacion">@trans('sol_redeterminaciones.falta_certificado_anterior', ['mes' => $valueInstancia->solicitud->fecha_certificado_anterior])</span>
  </div>
@endif
