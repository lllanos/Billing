                    ...
                    <div class="panel panel-default" >
                      <div class="panel-heading panel_heading_collapse p-0" role="tab" id="headingOne_sub_{{$level1->id}}">
                        <h4 class="panel-title titulo_collapse titulo_collapse_small m-0 panel_title_btn panel_heading_0">
                          ...
                          @if($level1->is_hoja && (Auth::user()->can('redeterminaciones-edit') || Auth::user()->can('redeterminaciones-view'))
                            && $redeterminacion->itemizado->contrato_moneda->lleva_analisis)
                            ...
                            <div class="dropdown container_btn_action dato-opciones" data-toggle="tooltip" data-placement="bottom" title="@trans('index.opciones')">
                              ...
                              <ul class="dropdown-menu pull-right">
                                ...
                                @if($precio->permite_editar)
                                  <li><a href="{{route('empalme.analisis_item.edit', ['item_id' => $itemId])}}"><i class="fa fa-pencil" aria-hidden="true"></i> @trans('index.editar') @trans('analisis_precios.analisis_item')</a></li>
                                @endif
                              </ul>
                            </div>
                          @else
